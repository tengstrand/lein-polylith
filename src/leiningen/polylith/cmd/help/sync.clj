...
(defn help []
  ...
  (println)
  (println "  2. Make sure that the library versions for all components")
  (println "     and bases are in sync with the library versions in")
  (println "     environments/development/project.clj.")
  (println)
  (println "  3. Make sure that each system has a library list that reflects")
  (println "     the sum of all libraries of its components and bases.")
  (println)
  (println "  lein polylith sync FLAG")
  (println "    FLAG = all  -> performs step 1-3.")
  (println "           deps -> performs step 1-3.")
  (println)
  (println "  examples:")
