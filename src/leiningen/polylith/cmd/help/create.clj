...
(defn help []
  ...
  (println "  --------------------------------------------------------")
  (println "  Creates a system:")
  (println)
  (println "  lein polylith create s[ystem] NAME BASE")
  (println "    NAME = System name.")
  (println "    BASE = Base name.")
  (println "  --------------------------------------------------------")
  (println "  Creates a workspace:")
  (println)
  (println "  lein polylith create w[orkspace] WS NS [FLAG]")
  ...
  (println "    FLAG = (omitted) -> version control the workspace with git.")
  (println "           -git      -> don't version control the workspace")
  (println "                        (may occur in any order).")
  (println)
  (println "  example:")
