...
(defn help []
  ...
  (println "    - checks for circular dependencies and quit if found.")
  ...
  (println "      and fulfill interfaces.")
  ...
  (println "    - if the entire build is successful and no steps are omitted, the success")
