  ...
  (with-redefs [file/current-path (fn [] @helper/root-dir)]
    (let [ws-dir (str @helper/root-dir "/ws1")
      ...
      (let [lines (helper/split-lines (slurp (str ws-dir "/doc/workspace.html")))]
        ...
        (is (= ["    <div class=\"component-ifc\" title=\"\" onclick=\"window.location='entities.html#c-interface';\""
                ">&nbsp;</div>"
                "  </div>"
                "  <div class=\"component\">"
                "    <div class=\"component-impl\" title=\"\" onclick=\"window.location='entities.html#logger-component';\""
                ...
                "  </div>"
                "  <p class=\"clear\"/>"
                "  <button onclick=\"myFunction('system1')\">Try it</button>"
                "  <table id=\"system1\" class=\"system-table\">"
                "    <tr>"
        ...
        (is (= [""
                ...
                "  <h3>comp-one</h3>"
                "  <button onclick=\"myFunction('comp-one')\">Try it</button>"
                "  <table id=\"comp-one\" class=\"system-table\">"
                "    <tr>"
                ...
                "  <h3>component2</h3>"
                "  <button onclick=\"myFunction('component2')\">Try it</button>"
                "  <table id=\"component2\" class=\"system-table\">"
                "    <tr>"
                "      <td class=\"tcomponent top\" onclick=\"window.location='entities.html#component2-component';\""
                ">component2</td>"
                "    </tr>"
                ...
                "  <h3>email</h3>"
                "  <button onclick=\"myFunction('email')\">Try it</button>"
                "  <table id=\"email\" class=\"system-table\">"
                "    <tr>"
                ...
                "  <h3>logger</h3>"
                "  <button onclick=\"myFunction('logger')\">Try it</button>"
                "  <table id=\"logger\" class=\"system-table\">"
                "    <tr>"
                "      <td class=\"tcomponent top\" onclick=\"window.location='entities.html#logger-component';\""
                ">logger</td>"
                "    </tr>"
                ...
                "  <h3>notadded</h3>"
                "  <button onclick=\"myFunction('notadded')\">Try it</button>"
                "  <table id=\"notadded\" class=\"system-table\">"
                "    <tr>"
