  ...
  (with-redefs [file/current-path (fn [] @helper/root-dir)]
    (let [ws-dir (str @helper/root-dir "/ws1")
      ...
      (is (= [""
              ...
              "  </tr>"
              "    <tr>"
              "      <td class=\"component-header\">comp&#8209;one</td>"
              "      <td class=\"center component-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"component-header\">component2</td>"
              "      <td class=\"center component-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"component-header\">email</td>"
              "      <td class=\"center component-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"component-header\">logger</td>"
              "      <td class=\"center component-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"component-header\">notadded</td>"
              "      <td class=\"center component-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"base-header\">system1</td>"
              "      <td class=\"center base-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"environment-header\">development</td>"
              "      <td class=\"center environment-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"system-header\">system1</td>"
              ...
              "  <tr>"
              "    <td></td>"
              "    <td class=\"environment-header\"><span class=\"vertical-text\">development</span></td>"
              "    <td class=\"system-header\"><span class=\"vertical-text\">system1</span></td>"
              "  </tr>"
              "  <tr>"
              "    <td class=\"component-header\">comp-one</td>"
              "    <td class=\"center component-row\">&#10003;"
