  ...
  (with-redefs [file/current-path (fn [] @helper/root-dir)]
    (let [ws-dir (str @helper/root-dir "/ws1")
      ...
      (is (= [""
              ...
              "<h3>Components</h3>"
              "  <div class=\"component\">"
              "    <div class=\"component-impl\" title=\"\" onclick=\"window.location='entities.html#comp-one';\">comp-one</div>"
              "    <div class=\"component-ifc-empty\" title=\"\">&nbsp;</div>"
              "  </div>"
              "  <div class=\"component\">"
              "    <div class=\"component-impl\" title=\"\" onclick=\"window.location='entities.html#component2';\">component2</div>"
              "    <div class=\"component-ifc\" title=\"\">interface1</div>"
              "  </div>"
              "  <div class=\"component\">"
              "    <div class=\"component-impl\" title=\"\" onclick=\"window.location='entities.html#email';\">email</div>"
              "    <div class=\"component-ifc-empty\" title=\"\">&nbsp;</div>"
              "  </div>"
              "  <div class=\"component\">"
              "    <div class=\"component-impl\" title=\"\" onclick=\"window.location='entities.html#logger';\">logger</div>"
              "    <div class=\"component-ifc-empty\" title=\"\">&nbsp;</div>"
              "  </div>"
              "  <div class=\"component\">"
              "    <div class=\"component-impl\" title=\"\" onclick=\"window.location='entities.html#notadded';\">notadded</div>"
              "    <div class=\"component-ifc-empty\" title=\"\">&nbsp;</div>"
              "  </div>"
              "<p class=\"clear\"/>"
              ""
              ...
              ""
              "  <div class=\"component\">"
              "    <div class=\"component-impl\" title=\"The component 'email' was added to 'system1' but has no references to it in the source code.\" onclick=\"window.location='entities.html#email';\">email</div>"
              ...
              "  </div>"
              "  <div class=\"component\">"
              "    <div class=\"component-impl\" title=\"The interface '&nbsp;' is referenced from 'system1' but a component that implements the '&nbsp;' interface also needs to be added to system1', otherwise it will not compile.\" onclick=\"window.location='entities.html#&nbsp;';\">&nbsp;</div>"
