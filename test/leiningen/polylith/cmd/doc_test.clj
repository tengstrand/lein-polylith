  ...
  (with-redefs [file/current-path (fn [] @helper/root-dir)]
    (let [ws-dir (str @helper/root-dir "/ws1")
      ...
      (is (= [""
              ...
              "  </div>"
              "  <div class=\"component\">"
              "    <div class=\"component-impl\" title=\"The interface '&nbsp;' is referenced from 'system1' but a component that implements the '&nbsp;' interface also needs to be added to system1', otherwise it will not compile.\" onclick=\"window.location='#&nbsp;-component';\""
              ">&nbsp;</div>"
              "    <div class=\"component-ifc\" title=\"The interface '&nbsp;' is referenced from 'system1' but a component that implements the '&nbsp;' interface also needs to be added to system1', otherwise it will not compile.\" onclick=\"window.location='#c-interface';\""
              ">notadded</div>"
              "  </div>"
              "  <p class=\"clear\"/>"
              ...
              "    </tr>"
              "    <tr>"
              "      <td class=\"tbase\" colspan=5 onclick=\"window.location='#system1-base';\""
              ">system1</td>"
              "    </tr>"
              "  </table>"
