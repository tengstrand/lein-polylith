  ...
  (with-redefs [file/current-path (fn [] @helper/root-dir)]
    (let [ws-dir (str @helper/root-dir "/ws1")
      ...
      (is (= [""
              ...
              "    </tr>"
              "    <tr>"
              "      <td class=\"component-row-header\">component2</td>"
              "      <td class=\"center component-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"component-row-header\">email</td>"
              "      <td class=\"center component-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"component-row-header\">logger</td>"
              "      <td class=\"center component-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"component-row-header\">notadded</td>"
              "      <td class=\"center component-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"base-row-header\">system1</td>"
              "      <td class=\"center base-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"environment-row-header\">development</td>"
              "      <td class=\"center environment-row\">&#10003;"
              "</td>"
              "    </tr>"
              "    <tr>"
              "      <td class=\"system-row-header\">system1</td>"
              ...
              "  <tr>"
              "    <td></td>"
              "    <td><div class=\"environment\">development</div></td>"
              "    <td><div class=\"system\">system1</div></td>"
              "  </tr>"
              "  <tr>"
              "    <td class=\"component-row-header\">comp-one</td>"
              "    <td class=\"center component-row\">&#10003;"
