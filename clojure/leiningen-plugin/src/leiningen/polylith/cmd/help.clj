...
(defn help [sha1 sha2]
  ...
  (println "    info [x] [s1 s2]     List interfaces, components, systems and builds")
  ...
  (println)
  (println "  Examples (execute anywhere):")
  (println "    lein polylith help info")
  (println "  Examples (execute from the workspace root):")
  ...
  (println "  Examples (execute from the development directory):")
...
(defn info [sha1 sha2]
  ...
  (println "    x = a -> show all interfaces, components, systems and builds")
  (println "        c -> show changed interfaces, components, systems and builds")
  (println "        u -> show unchanged interfaces, components, systems and builds")
  (println "        (omitted) -> show all components, systems, builds (and interfaces if changed)")
  (println "    s1 = last (successful) Git sha1")
  (println "    s2 = current Git sha1")
  (println)
  (println "  example:")
