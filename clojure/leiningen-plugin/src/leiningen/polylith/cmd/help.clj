...
(defn help [sha1 sha2]
  ...
  (println)
  (println "    changes x s1 s2      List changed components, bases or builds between two Git hashes")
  ...
  (println "    info [x] [s1 s2]     List interfaces, components, bases and builds")
...
(defn build [sha1 sha2]
  (println "  Compile, test, and build components, bases, builds between two Git hashes.")
  (println "")
...
(defn info [sha1 sha2]
  ...
  (println "    x = a -> show all interfaces, components, bases and builds")
  (println "        c -> show changed interfaces, components, bases and builds")
  (println "        u -> show unchanged interfaces, components, bases and builds")
  (println "        (omitted) -> show all components, bases, builds (and interfaces if changed)")
  (println "    s1 = last (successful) Git sha1")
  (println "    s2 = current Git sha1")
  (println)
  (println "  example:")
