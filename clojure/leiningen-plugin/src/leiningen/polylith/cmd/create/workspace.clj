...
(defn create [path name ws-ns top-dir clojure-version clojure-spec-version]
  (let [ws-path (str path "/" name)
    ...
    (shared/create-src-dirs! ws-path top-dir "/interfaces/src")
    (shared/create-src-dirs! ws-path top-dir "/environments/development/src")
    (shared/create-src-dirs! ws-path top-dir "/environments/development/test")
